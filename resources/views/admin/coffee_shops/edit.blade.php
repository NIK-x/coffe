...
@section('title', 'Редактировать кофейню')

@section('content')
<div class="card">
    <h2 style="margin-bottom: 2rem;">Редактировать кофейню</h2>
    ...
    <form action="{{ route('admin.coffee-shops.update', $coffeeShop) }}" method="POST">
        ...
        <div class="d-flex gap-2">
            <button type="submit" class="btn btn-primary">Обновить кофейню</button>
